      ...
      <div className="bg-[#1e1e1e] border border-white/10 rounded-xl p-6 max-w-md w-full relative shadow-2xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                    <label className="block text-xs text-gray-500 uppercase font-bold mb-1">Time</label>
                    <input 
                        type="text" 
                        value={formData.time}
            ...
            <div>
                <label className="block text-xs text-gray-500 uppercase font-bold mb-1">Location</label>
                <input 
                    type="text" 
            ...
            <div>
                <label className="block text-xs text-gray-500 uppercase font-bold mb-1">Details</label>
                <textarea 
