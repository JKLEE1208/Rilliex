      ...
      <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
        ...
        >
          ...
          <div className="flex flex-col">
              <span className="text-x1 font-bold tracking-[0.2em] text-white font-sans uppercase leading-none">
                RillieX
              </span>
              <span className="text-[9px] text-tennis-green tracking-[0.42em] uppercase leading-none mt-1 group-hover:tracking-[0.4em] transition-all">
                Portfolio
              </span>
          </div>
        </div>
